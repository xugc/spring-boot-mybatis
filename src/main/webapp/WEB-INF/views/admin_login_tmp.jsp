		...
		<div class="login_form">
			<form action="submit" method="post">
				...
				<div class="form_info">
					<div class="field">
						<label>用户名：</label>
						<input name="userName" type="text" class="text" size="20" value="${ info.userName }">
					</div>
					<div class="field">
						<label>密 码：</label>
						<input name="userPwd" type="password" class="text" size="20">
					</div>
					<div class="field">
						<label>验证码：</label>
						<input name="validateNumber" type="text" class="text" size="10" value="${ info.validateNumber }">
					</div>
					<div class="field">
						<cite>
